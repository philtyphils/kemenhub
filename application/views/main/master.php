<script type="text/javascript" src="<?php echo $baseurl;?>assets/js/master.js?v=<?php echo uniqid(); ?>"></script> 
                            ...
                            <div class="card">
                                <div class="header-master">
                                    <div class="header">
                                        ...
                                        <p class="category" style="color: #AAAAAA; font-weight: 300;">Jumlah KELAS KUPP / KSOP</p>
                                    </div>
